...
function toggleSidebar() {
    ...
    document.getElementById("burger").classList.toggle("burger-inactive");
}
...
pageWrapper.addEventListener("click", function(event) {
    if (!sideBar.contains(event.target)) {
        ...
        document.getElementById("burger").classList.remove("burger-inactive");
    }
});
    ...
    <div id="modalBox" class="modal-box" style="display: none;">
        <div class="modal-container" id="modalContainer">
            ...
            <div class="modal-btn-wrapper">
                ...
                <button class="modal-cancel" id="modalCancel" style="display:none;">Cancel</button>
            </div>
        </div>
    </div>
`);
...
modalBox.addEventListener("click", (e) => {
    if (!modalContainer.contains(e.target) && modalResolve) {
        modalResolve(false); // user dismissed
    }
});
...
function closeModal() {
    ...
    modalResolve = null; // just cleanup
}
...
function modalMsg(msg) {
    return new Promise(resolve => {
        ...
        modalOk.onclick = () => modalResolve(true);
    });
}
...
function modalConfirm(msg) {
    return new Promise(resolve => {
        ...
        modalOk.onclick = () => modalResolve(true);
        modalCancel.onclick = () => modalResolve(false);
    });
}
