...
if (localStorage.getItem("user_name")) {
    document.getElementById("welcome").textContent ="Welcome, " + localStorage.getItem("user_name") + "!";
}
if (localStorage.getItem("member_id")) {
    document.getElementById("memberId").textContent ="Member ID: " + localStorage.getItem("member_id");
}
