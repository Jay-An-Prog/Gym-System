...
function updater() {
    // For membership -----------
    if ((sessionStorage.getItem("subscription_status") === "pending" || sessionStorage.getItem("subscription_status") === "rejected")
      && sessionStorage.getItem("status") === "activated") {

        // Toggle between pending and rejected UI
        if (sessionStorage.getItem("subscription_status") === "pending") {
            ...
            // ---- Rejected UI ----
            if (document.getElementById("subscriptionStatus").textContent !== "Rejected")
                document.getElementById("subscriptionStatus").textContent = "Rejected";
            // Add color effect of status box
            document.getElementById("statusBox").classList.remove("pending-status-box");
            document.getElementById("statusBox").classList.remove("active-status-box");
            document.getElementById("statusBox").classList.add("expired-status-box"); // Borrow expired UI style
        }
        ...
        // Show rejected of payment via gcash
        if (sessionStorage.getItem("subscription_status") === "rejected") {
            // Only appear in rejected UI
            if (document.getElementById("subscriptionDuration").textContent !== "Your payment proof was not approved. Please upload a clearer or correct GCash receipt and try again.")
                document.getElementById("subscriptionDuration").textContent = "Your payment proof was not approved. Please upload a clearer or correct GCash receipt and try again.";
        ...
        } else if (sessionStorage.getItem("payment_method") === "gcash") {
