...
async function generateAIOutput(aiInput) {
    const apiKey = "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";
        ...
        messages: [
            {
                role: "system",
                content: `
                    You are a certified strength and conditioning coach. I will give you a user's personal info and a workout log. 
                    ...
                    Adjust sets, reps, weight, and rest dynamically according to the workout log and the user's personal 
                    info. Encourage progressive overload in safe, small steps. 
                    Point out technique issues or muscle imbalances only when the exercise is clearly understood. 
                    Suggest exercise variations or progressions only for recognized movements. For bodyweight exercises, 
