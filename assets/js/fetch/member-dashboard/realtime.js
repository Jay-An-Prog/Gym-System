...
const getUserInfo = "https://script.google.com/macros/s/AKfycbz-ref7_TG11ac0JOXiwoYFbULfFW_ZBnbEbNjLpx5tF4nFlvqSQOb_YVPHB2cgPNol/exec";
        ...
        switch (data.result) {
            ...
            case "success": { // Put curly braces so const fullName stays properly scoped (otherwise, in some strict setups, declaring const inside a switch without {} can cause issues).
                ...
                if (data.result === "success") {
                    ...
                    sessionStorage.setItem("daily_expiration", data.daily_expiration);
                    sessionStorage.setItem("qr_checkin", data.qr_checkin);                  
                }
                break;
            }     
            case "fail": 
                ...
                sessionStorage.removeItem("daily_expiration");
                break;
            default:
