...
async function generateAIOutput(aiInput) {
    const apiKey = "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"; // Replace with your real key or move to backend for security
        ...
        messages: [
            {
                ...
                content: `
                    ...
                    Give general fitness nutrition guidance only.
                    Do not give medical advice, diagnoses, or supplement dosages.
                    Do not ask questions.
                    Do not use bullets, symbols, or markdown.
                    Speak in friendly, plain sentences directly to the user.

                    Base advice on calories, protein intake, training recovery,
                    hydration, meal timing, and consistency.
                    Avoid extreme dieting or restrictive behavior.
