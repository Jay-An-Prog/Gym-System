...
async function loadNutritionData() {
    ...
    if (sessionStorage.getItem("calories_target")) { // Period helps trigger this condition
    ...
    try {
        ...
        sessionStorage.setItem("calories_target", nutritionData.calories_target || "."); // Added period to only run firestore fetching once
...
async function loadAIOutput() {
    ...
    let age, bodyHeightCm, bodyWeightKg, activity, sex, goal;

    sex = sessionStorage.getItem("sex");
    age = sessionStorage.getItem("age");
    bodyHeightCm = sessionStorage.getItem("body_height_cm");
    bodyWeightKg = sessionStorage.getItem("body_weight_kg");
    ...
    try {
        ...
        hideForm(); // Hide nutrition form to render AI Output
