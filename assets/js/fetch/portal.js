...
window.onload = function() {
  google.accounts.id.initialize({
    client_id: "367834992185-37m1mveu60r10oa04cmvsggj4ge1hs0t.apps.googleusercontent.com",
...
function handleGoogleCredential(response) {
  ...
  const google_email = data.email.toLowerCase();
  const google_name = data.name;

  // Call your same login handler but with Google action
  const formData = {
    action: "google login",
    sonic_email: google_email,
